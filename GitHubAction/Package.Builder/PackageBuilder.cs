namespace Package.Builder
{
	...
	public class GitHubActionLogger : ILogCollector
	{
		...
		public GitHubActionLogger(IPackagePresenter presenter, bool logDebug = false)
		{
		...
		public void ReportDebug(string warning)
		{
			if (_logDebug)
			{
				_logging.Add("DEBUG: " + warning);
			}
		}
	...
	public class PackageBuilder : IPackageBuilder
	{
			...
			LocalPackageConfig localPackageConfig)
		{
			...
			var logger = new GitHubActionLogger(_presenter, localPackageConfig.Debug);
