...
public interface IArtifactUploadApi
{
    ...
    Task<PrivateArtifactModel> ArtifactUploadV11PrivateArtifactPostAsync(byte[] package, string name, string key, CatalogData catalog, CancellationToken cancellationToken, IPackagePresenter presenter);
}